...
//	/**
//	 * Need to add some conditions that will get us the expand/collapse icon on the
//	 * vertex.
//	 */
//	@Override
//	public boolean isCellFoldable(Object cell, boolean collapse) {
//		// I want to keep the original behavior for groups in case I use a group
//		// someday.
...
//	 * traverse the tree collecting all child vertices and then hide/show them and
//	 * their edges as needed.
//	 */
//	@Override
